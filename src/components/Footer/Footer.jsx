...
export const Footer = () => {
  return (
   <>
 <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-neutral-900">
  {/* Grid */}
  <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
    <div>
      <a className="flex-none text-xl font-semibold text-black focus:outline-hidden dark:text-white" href="#" aria-label="Brand">Urbano Fernando</a>
    </div>
    {/* End Col */}
